...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, state_dim, action_dim, num_queries, use_lang_instruction=False):
        super().__init__()
    ...
    def forward(self, obs, lang_instruction = None, actions=None):
