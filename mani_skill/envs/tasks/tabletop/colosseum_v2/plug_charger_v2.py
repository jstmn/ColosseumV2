...
class PlugChargerColosseumV2Env(ColosseumV2Env):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def _default_sensor_configs(self):
        ...
        return self.update_camera_configs([
            CameraConfig("base_camera", pose=pose, width=224, height=224, fov=np.pi / 2)
        ])
    ...
    def _get_charger_builder(self, peg_size, base_size, gap):
    ...
    def _load_scene(self, options: dict):
        def get_charger_builder():
            return self._get_charger_builder(
                self._peg_size,
                self._base_size,
                self._peg_gap,
            )
        def get_receptacle_builder():
            return self._get_receptacle_builder(
                [
                self._peg_size[0],
        ...
        self.charger = self.add_asset_to_scene(get_charger_builder, name="charger", physics_type="dynamic", object_type="MO")
