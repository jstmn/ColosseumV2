...
def solve(env, seed, debug=False, vis=False):
    ...
    try:
        ...
        lift_1 = sapien.Pose(
            p=np.array([0.0, -0.0, 1.515]),
            q=np.array([0.5,0.5,0.5,0.5])
        )
        
        lift_2 = sapien.Pose(
            p=np.array([0.0, 0.0, 1.067]),
            q=np.array([0.5, -0.5, 0.5, -0.5])
        )
        
        ready_lift_1 = lift_1 * sapien.Pose(p=[0,0,-0.3])
        ready_lift_2 = lift_2 * sapien.Pose(p=[0,0,-0.3])
        ...
        pull_2 = lift_2 * sapien.Pose(p=[0, 0, -0.3])
