...
def solve(env: BaseEnv, debug=False, vis=False):
    ...
    elif env.unwrapped.robot_uids == "panda" or env.unwrapped.robot_uids == "panda_wristcam" or env.unwrapped.robot_uids == "panda_wristcam_224":
    ...
    while True:
        ...
        if execute_current_pose:
            ...
            if env.unwrapped.robot_uids == "panda" or env.unwrapped.robot_uids == "panda_wristcam" or env.unwrapped.robot_uids == "panda_wristcam_224":
