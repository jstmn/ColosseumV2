...
def convert():
    ...
    with h5py.File(output_h5, "w") as out_f:
        demo_len =50 # set your episode len
        for i in tqdm(range(demo_len), desc=f"Converting {target_size[0]}x{target_size[1]}"):
